...
<body>
  ...
  <div class="container">
    ...
    <form method="post" action="php/traitement_commande.php">
      ...
      <select name="service" id="service" required>
        <option value="">-- Sélectionner un service facebook --</option>
    ...
    <div style="background-color: #d292ff; border-radius: 10px; padding: 15px; color: #000;">
  <p><strong>Notes:</strong></p>
  <ol>
    <li>Si la publication provient d'un compte Facebook, assurez-vous que les publications du compte sont publiques !</li>
    <li>Si vous avez déjà acheté des j'aime et que vous souhaitez en acheter à nouveau pour la même publication, assurez-vous que votre commande précédente est déjà terminée !</li>
  ...
  <script>
    ...
    function updatePrice() {
      ...
      const total = (qty * selected.rate *760 / 1000).toFixed(4);
